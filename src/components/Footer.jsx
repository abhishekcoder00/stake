...
export default function Footer() {
  ...
  return (
    <div>
      <div className="footer absolute left-[18.1%] right-0 bg-[#2d4454]  text-white mt-8 pb-5">
        <Container>
          <div className="container px-4 py-3 mx-auto">
            <div className="flex -mx-4">
              <div className="w-full px-4 mb-8 sm:w-1/4">
                <h3 className="text-[16px] font-bold mb-4">Sports</h3>
                <ul>
                  <li>
              ...
              <div className="w-full px-4 mb-8 sm:w-1/4">
                <h3 className="text-[16px] font-bold mb-4">Casino</h3>
                <ul>
                  <li>
                    <a href="#" className="hover:text-gray-400">
                      Casino Games
              ...
              <div className="w-full px-4 mb-8 sm:w-1/4">
                <h3 className="text-[16px] font-bold mb-4">Support</h3>
                <ul>
                  <li>
                    <a href="#" className="hover:text-gray-400">
                      Fairness
              ...
              <div className="w-full px-4 mb-8 sm:w-1/4">
                <h3 className="text-[16px] font-bold mb-4">Community</h3>
                <ul>
                  <li>
                    <a href="#" className="hover:text-gray-400">
                      Blog
              ...
              <div className="w-full px-4 mb-8 sm:w-1/4">
                <h3 className="text-[16px] font-bold mb-4">Language</h3>
                <ul>
          ...
          <hr className="border-[1px] mx-3 " />
          {/* footer midware Start */}
          <div className="midwire-footer pt-8  bg-[#2d4454]  pb-8">
            <div className="grid grid-cols-5 gap-6">
              {FooterData?.map((d, i) => (
                <div key={i} className="bg-[transparent]">
                  <img src={d.image} alt={`Footer image ${i}`} />
                </div>
              ))}
            </div>
            <div className="text-white text-center text-[25px] font-bold mt-7">
              <span>18+</span>
            </div>
          </div>
          {/* footer midware End  */}
          <hr className="border-[1px] mx-3 " />
          {/* footer midware-1 */}
          <div className="pt-10 midwire-footr">
            <div className="grid grid-cols-4 gap-6 justfiy-center">
             ...
             <svg
                ...
                class="svelte-dmytnz  max-w-[150px]"
              >
                <g id="_Group_" data-name="<Group>">
                  <path
                    class="cls-1 svelte-dmytnz fill-white"
                ...
                <path
                  class="cls-2 svelte-dmytnz fill-white"
                ...
                ></path>
                <path
                  class="cls-3 svelte-dmytnz fill-white"
...
{/* footer bootom Start */}
  ...
  <div className="container mx-auto text-center">
    ...
    {/* <p className="mb-4">
      Payment agent company is Medium Rare Limited with address 7-9 Riga
      Feraiou, LIZANTIA COURT, Office 310, Agioi Omologites, 1087 Nicosia,
      Cyprus and Registration number: HE 410775
    </p> */}
    <div className="flex justify-center space-x-4">
      ...
      >
       ...
       <span className="ml-2 text-white">support@stake.com</span>
       "|"
      </a>
      <a
        href="https://partners.stake.com"
        className="text-blue-500 hover:text-blue-400"
      >
       <span className="text-gray-300"> Partners</span>
       <span className="ml-2 text-white">partners.stake.com</span>
       "|"
      </a>
      <a
        href="https://press.stake.com"
        className="text-blue-500 hover:text-blue-400"
      >
       <span className="text-gray-300">Press</span>
       <span className="ml-2 text-white">press.stake.com</span>
  
      </a>
    </div>
    <div className="flex flex-col items-center justify-center gap-3 mt-8 space-x-4">
      <a href="https://www.x-next.com/" target="_blank">
        <img
          src="image/c3fe90d70c1455793ecb72e8436d329c-stake.png"
          alt="X-Next Logo"
          className="w-12 h-12"
        />
      </a>
      <a href="https://sportsbet.io/" target="_blank" className="p-0">
        <img
          src="image/c3fe90d70c1455793ecb72e8436d329c-stake (1).png"
